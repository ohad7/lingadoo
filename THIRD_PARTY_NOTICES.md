...
The app includes Noto Sans font files under `public/fonts/` for browser-side PDF export. Noto fonts are distributed by Google under the SIL Open Font License. See:

- https://fonts.google.com/noto
- https://openfontlicense.org/

The app also uses standard fonts bundled with `pdfjs-dist` during local preview rendering.
